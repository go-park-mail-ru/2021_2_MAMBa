...
INSERT INTO person VALUES (DEFAULT, 'Thomas Vinterberg', 'Томас Винтерберг', '', 'Режиссер, Сценарист', 183, 52, '1969-05-19', NULL ,'Копенгаген, Дания','','Муж.','Хелена Рейнгор Нойманн', NULL),
...
INSERT INTO filmgenres VALUES (1, 2),
                              (1, 3),
                              (2, 2),
                              (3, 2),
                              (4, 2),
                              ...
                              (8, 9),
                              (8, 10);
INSERT INTO countryproduction VALUES (1, 1),
                                     (1, 2),
                                     (2, 1),
                                     (3, 4),
                                     (4, 4),
...
INSERT INTO filmcast VALUES (1, 3), (1, 4), (1, 5),
                            (2, 8), (2, 9), (2, 10),
                            (3, 8), (3, 13),
                            (4, 8), (4, 16),
                            (5, 8), (5, 19), (5, 20),
...
INSERT INTO review VALUES (DEFAULT, 1, 1, 'норм', 0, 5.0, current_date),
                          (DEFAULT, 1, 2, ')', 0, 6.0, current_date),
                          (DEFAULT, 1, 3, 'ао ', 0, 7.0, current_date),
                          (DEFAULT, 1, 4, 'неплохо', 0, 7.0, current_date),
                          (DEFAULT, 1, 5, 'скучно', 0, 2.0, current_date),
                          (DEFAULT, 1, 6, 'да', 0, 7.0, current_date),
                          (DEFAULT, 1, 7, 'интересно', 0, 8.0, current_date),
                          (DEFAULT, 1, 8, 'отвал башки', 0, 10.0, current_date),
                          (DEFAULT, 2, 1, 'ввввввв', 0, 1.0, current_date),
                          (DEFAULT, 2, 8, '', 0, 9.0, current_date),
                          (DEFAULT, 3, 8, '', 0, 5.0, current_date);