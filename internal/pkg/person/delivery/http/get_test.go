...
var testTableGetPersonSuccess = [...]testRow{
	{
		inQuery: "id=9",
		out:     `{"actor":{"id":9,"name_rus":"Сэм Клафлин","career":[""],"height":180,"age":20,"birthday":"0001-01-01 00:00:00 +0000 UTC","death":"0001-01-01 00:00:00 +0000 UTC","gender":"male"},"films":{"film_list":[{"id":2,"title":"С любовью, Рози","description":"Рози и Алекс были лучшими друзьями с детства, и теперь, по окончании школы, собираются вместе продолжить учёбу в университете.\\n\\nОднако в их судьбах происходит резкий поворот, когда после ночи со звездой школы Рози узнаёт, что у неё будет ребенок. Невзирая на то, что обстоятельства и жизненные ситуации разлучают героев, они и спустя годы продолжают помнить друг о друге и о том чувстве, что соединило их в юности…","poster_url":"server/images/love-rosie.webp","release_year":2014,"director":{},"screenwriter":{}}],"more_avaliable":false,"film_total":1,"current_limit":10,"current_skip":10},"popular_films":{"film_list":[{"id":2,"title":"С любовью, Рози","description":"Рози и Алекс были лучшими друзьями с детства, и теперь, по окончании школы, собираются вместе продолжить учёбу в университете.\\n\\nОднако в их судьбах происходит резкий поворот, когда после ночи со звездой школы Рози узнаёт, что у неё будет ребенок. Невзирая на то, что обстоятельства и жизненные ситуации разлучают героев, они и спустя годы продолжают помнить друг о друге и о том чувстве, что соединило их в юности…","poster_url":"server/images/love-rosie.webp","release_year":2014,"director":{},"screenwriter":{}}],"more_avaliable":false,"film_total":1,"current_limit":10,"current_skip":10}}` + "\n",
...
var testTableGetPersonFilmsSuccess = [...]testRow{
	{
		...
		out:     `{"film_list":[{"id":1,"title":"Еще по одной","description":"В ресторане собираются учитель истории, психологии, музыки и физрук, чтобы отметить 40-летие одного из них. И решают проверить научную теорию о том, что c самого рождения человек страдает от нехватки алкоголя в крови, а чтобы стать по-настоящему счастливым, нужно быть немного нетрезвым. Друзья договариваются наблюдать, как возлияния скажутся на их работе и личной жизни, и устанавливают правила: не пить вечером и по выходным. Казалось бы, что может пойти не так?","poster_url":"server/images/one-more-drink.webp","release_year":2020,"director":{},"screenwriter":{}}],"more_avaliable":false,"film_total":1,"current_limit":10,"current_skip":10}` + "\n",
		status:  http.StatusOK,
		name:    `full works`,
		skip:    0,
		limit:   10,
