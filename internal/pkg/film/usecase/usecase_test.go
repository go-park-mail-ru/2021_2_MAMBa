...
func TestGetPopular(t *testing.T) {
	...
	res := domain.FilmList{FilmList: []domain.Film{{Id: 1}}, MoreAvailable: true, FilmTotal: 1, CurrentLimit: 10, CurrentSkip: 10}
...
func TestGetBanners(t *testing.T) {
	...
	res := domain.BannersList{BannersList: []domain.Banner{{Id: 1}}}
...
func TestGetGenres(t *testing.T) {
	...
	res := domain.GenresList{GenresList: []domain.Genre{{Id: 1}}}
